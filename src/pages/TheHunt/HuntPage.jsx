            ...
            <div className="row">
                <div className="leftcolumn">
                  ...
                  <div className="card">
                    ...
                    <h3><Link to="/thenightitstarted">The Night That Started It All: The Mystic Campers Origin Story</Link></h3>
                  ...
                  <div className="card">
                    ...
                    <h3><Link to="/intotheunknown">Into the Unknown: The Fairy Ring of Siuslaw National Forest</Link></h3>
